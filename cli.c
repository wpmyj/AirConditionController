...
EmberCommandEntry emberCommandTablePluginScenesCommands[] = {
...
PGM_P PGM emberCommandTablePluginReportingAddCommandArguments[] = {
...
PGM_P PGM emberCommandTablePluginReportingRemoveCommandArguments[] = {
  "The index of the report to be removed.",
  NULL
};

EmberCommandEntry emberCommandTablePluginReportingCommands[] = {
...
EmberCommandEntry emberCommandTablePluginOtaStorageEepromCommands[] = {
#if defined(EMBER_AF_PLUGIN_OTA_STORAGE_SIMPLE_EEPROM) && !defined(EMBER_AF_PLUGIN_OTA_STORAGE_SIMPLE_EEPROM_READ_MODIFY_WRITE_SUPPORT)
...
PGM_P PGM emberCommandTablePluginOtaClientBootloadCommandArguments[] = {
  "The index at which to begin bootloading the image",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaClientPageRequestCommandArguments[] = {
  "boolean value turning on (1) or off (0) the page request flag",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaClientPauseAtCommandArguments[] = {
  "stop download percentage",
  NULL
};

PGM_P PGM emberCommandTablePluginOtaClientVerifyCommandArguments[] = {
  "The index at which to begin verification of the image",
  NULL
};

EmberCommandEntry emberCommandTablePluginOtaClientCommands[] = {
...
EmberCommandEntry emberCommandTablePluginOtaBootloadCommands[] = {
...
PGM_P PGM emberCommandTablePluginEepromDataPrintCommandArguments[] = {
  "The offset within the EEPROM to print.",
  NULL
};

EmberCommandEntry emberCommandTablePluginEepromCommands[] = {
